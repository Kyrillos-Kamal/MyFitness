...
public class CaloriesCalculatorMaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calories_calculator_male);
    ...
    public void CaloriesResult(){
        ...
        if (EquationofHarrisBenedict.isChecked()){
            Result = (Age * 6.8 * Height) + (13.8 * Weight) + 66.5;
        }
