...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnBodyFat).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.btnCaloriesCalculator).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
